        ...
        <div class="container-table" id="${id}" style="width:100%;justify-content:center">
            ...
            <div class="box">
                <a class="button_download" href="" style="display:none">
                    <img src="/static/logo/download_green.png" alt="#" title="Download Image">
                </a>
                <button class="button_delete" style="display:none">
                    <img src="/static/logo/remove.png" alt="#" title="Remove Image">
                </button>
            </div>
        </div>
    `;
...
var detailsElement = `
          <div class="details"style="flex-direction:row">
            <span class="func_name">Analysis</span>
            <span class="percent"></span>
        </div>
`
...
function formatTimeLeft(time){
    ...
    return `after ${hour}:${minutes}:${seconds}`;
}
...
//            console.log('click');
    ...
    //                                console.log(progressHTML);
                        ...
                        alert('This file format not available now.');
                        $('form').reset();
                    }
                };
    })
...
//        console.log(data);
        ...
        if (infoFunc == 'Predict'){
            infoFunc = 'Analysis';
                ...
                infoFunc = 'Create archive';
            } else if(infoFunc == 'unzip'){
                infoFunc = 'Prepare data';
            };
...
//                console.log(data);
                if (data['state'] == 'SUCCESS') {
                            ...
                            $(`#${element_id} > #status > div > div.details > span.name`).text('Analysis is finished');
